			...
			<el-form ref="form1" :model="form1" :rules="rules" size="medium" label-width="100px">
				<el-col :span="16">
					<el-form-item label="题库名称" prop="title">
						<el-input v-model="form1.title" placeholder="请输入题库名称" clearable :style="{width: '100%'}">
						</el-input>
					</el-form-item>
				</el-col>
				<el-col :span="8">
					<el-form-item label="所属分类" prop="category_id">
						<vk-data-input-remote-select v-model="form1.category_id" placeholder="请选择题库分类"
							action="admin/q_bank/bank_category/sys/categories"
				...
				<el-col :span="8">
					<el-form-item label="售价" prop="charge">
						<vk-data-input-money v-model="form1.charge" placeholder="请输入售价" :rightText="'元'" width="100%">
						</vk-data-input-money>
					</el-form-item>
				</el-col>
				<el-col :span="8">
					<el-form-item label="原价" prop="charge_original">
						<vk-data-input-money v-model="form1.charge_original" placeholder="请输入原价" :rightText="'元'"
							width="100%">
						</vk-data-input-money>
					</el-form-item>
				</el-col>
				...
				<el-col :span="8">
					<el-form-item label="显示状态" prop="is_show">
						<el-select v-model="form1.is_show" placeholder="请选择显示状态" clearable :style="{width: '100%'}">
				...
				<el-col :span="24">
					<el-form-item label="简介" prop="short_description">
						<el-input v-model="form1.short_description" type="textarea" placeholder="请输入简介"
