	...
	<view class="page-body">
		<el-row :gutter="15">
			<el-form ref="form1" :model="form1" :rules="rules" size="medium" label-width="100px">
				...
				<el-col :span="8">
					<el-form-item label="图文分类" prop="category_id">
						<vk-data-input-remote-select v-model="form1.category_id" placeholder="请选择图文分类"
							action="admin/pay-articles/category/sys/categories"
				...
				<el-col :span="8">
					<el-form-item label="图文封面" prop="avatar" required>
				...
				<el-col :span="24">
					<el-form-item label="图文摘要" prop="excerpt">
						<el-input v-model="form1.excerpt" type="textarea" placeholder="请输入图文摘要"
							:autosize="{minRows: 4, maxRows: 4}" :style="{width: '100%'}"></el-input>
					</el-form-item>
				</el-col>
				<el-col :span="24">
					<el-form-item label="图文试读" prop="free_content">
						<vk-data-input-editor v-model="form1.free_content" placeholder="请输入图文试读部分" width="100%">
						</vk-data-input-editor>
					</el-form-item>
				</el-col>
				<el-col :span="24">
					<el-form-item label="图文正文" prop="content">
						<vk-data-input-editor v-model="form1.content" placeholder="请输入图文正文" width="100%">
						</vk-data-input-editor>
					</el-form-item>
				</el-col>
