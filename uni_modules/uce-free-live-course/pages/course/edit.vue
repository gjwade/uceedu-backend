	...
	<view class="page-body">
		<el-row :gutter="15">
			<el-form ref="form1" :model="form1" :rules="rules" size="medium" label-width="100px">
				<el-col :span="16">
					<el-form-item label="公开课标题" prop="title">
						<el-input v-model="form1.title" placeholder="请输入课程标题" clearable :style="{width: '100%'}">
						</el-input>
					</el-form-item>
				</el-col>
				<el-col :span="8">
					<el-form-item label="公开课分类" prop="category_id">
						<vk-data-input-remote-select v-model="form1.category_id" placeholder="请选择公开课分类"
							action="admin/free_live_course/category/sys/categories"
				...
				<el-col :span="8">
					<el-form-item label="课程售价" prop="charge">
						<vk-data-input-money v-model="form1.charge" placeholder="请输入课程售价,0元免费" :rightText="'元'"
							width="100%">
						</vk-data-input-money>
					</el-form-item>
				</el-col>
				<el-col :span="8">
					<el-form-item label="开播时间" prop="publish_date">
				...
				<el-col :span="24">
					<el-form-item label="自定义流" prop="title">
						<el-input v-model="form1.live_stream" placeholder="不为空时,优先级比线上开播高" clearable :style="{width: '100%'}">
						</el-input>
					</el-form-item>
				</el-col>
				<el-col :span="24">
					<el-form-item label="公开课封面" prop="avatar" required>
				...
				<el-col :span="24">
					<el-form-item label="简单描述" prop="excerpt">
						<el-input v-model="form1.excerpt" type="textarea" placeholder="请输入公开课简单描述"
							:autosize="{minRows: 4, maxRows: 4}" :style="{width: '100%'}"></el-input>
					</el-form-item>
				</el-col>
				<el-col :span="24">
					<el-form-item label="公开课介绍" prop="content">
						<vk-data-input-editor v-model="form1.content" placeholder="请输入公开课介绍" width="100%">
